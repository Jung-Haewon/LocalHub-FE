...
.panel { width:450px; max-height:650px; resize: both; background:var(--panel); border-radius:10px; box-shadow:0 12px 40px rgba(0,0,0,.45); margin-right:12px; overflow:auto; display:flex; flex-direction:column; transform-origin:100% 100%; animation: fadeIn .12s ease; }
